  ...
  return [
    ...
    },
    {
      ...
      entries: [
        ...
        { kind: "item", id: "theme_claude", label: "Claude 主题", mark: "dot", marked: theme === "claude" },
        { kind: "item", id: "theme_claude_dark", label: "Claude Dark 主题", mark: "dot", marked: theme === "claude-dark" },
        { kind: "item", id: "theme_ios", label: "iOS 主题", mark: "dot", marked: theme === "ios" },
        { kind: "item", id: "theme_ios_dark", label: "iOS Dark 主题", mark: "dot", marked: theme === "ios-dark" },
        sep(),
